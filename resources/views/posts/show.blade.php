	...
	<div class="md:w-1/2 p-5">
		<div class="shadow bg-white p-5 mb-5">
			...
			<form action="{{ route('comentario.store', ['user' => $user, 'post' => $post]) }}" method="POST">
				...
				@enderror
				<input type="submit" value="Comentar" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg" name="">
			</form>
			@endauth
