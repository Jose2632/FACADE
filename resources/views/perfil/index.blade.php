...
<div class="md:flex md:justify-center">
	...
	<div class="md:w-1/2 bg-white shadow p-6">
		...
		<form action="{{ route('perfil.store') }}" class="mt-10 md:mt-0" method="POST" enctype="multipart/form-data">
			...
			<input type="submit" value="Guardar Cambios" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg" name="">
		</form>
